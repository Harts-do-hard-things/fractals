...
- enum values (preferred): `Chaos`, `Parallel`, `PointDeterministic`, `ImageIterate`, `Inverse`, `RenderTransformations`
- symbols: `:chaos`, `:parallel`, `:point_deterministic`, `:image_iterate`, `:inverse`, `:render_transformations`
- strings: `"chaos"`, `"parallel"`, `"point_deterministic"`, `"image_iterate"`, `"inverse"`, `"render_transformations"`
...
- `method=RenderTransformations` renders the transformed initial polygon directly, without chaos/image iteration.
...
- `ImageIterate` options:
  - `image_source=:polygon|:chaos|:point_deterministic|:inverse|:file`
    - `:polygon` is generated by `render_transformations_png(...; show_base=false, initial_polygon=...)` and then converted to grayscale
...
- `RenderTransformations` options:
  - `initial_polygon=:default|:equilateral_triangle|:line_arrow|:line`
  - `show_base=true|false`
  - `axis=true|false`
  - `color=true|false`
